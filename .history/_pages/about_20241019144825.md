...
- *2024.08*: 🎉🎉 Our **VQAScore** was recognized by Imagen as the leading text-to-vision evaluation metric, and our benchmark, GenAI-Bench, was also extensively utilized by Imagen. Our evaluation metric **VQAScore** and benchmark GenAI-Bench() were heavily used by **Imagen**.
