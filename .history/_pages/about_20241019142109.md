...
Hello! I am **Baiqi Li** (李百奇), a research assistant at Carnegie Mellon University, working under the guidance of Professor Deva Ramanan. I am also an intern at Texas A&M University, supervised by Zhengzhong Tu. I graduated in June 2024 with a master's degree from the School of Computer Science at East China Normal University. My research focuses on computer vision and language, particularly on evaluation metrics and benchmarks for vision-language models (VLMs) and multimodal generative models.
