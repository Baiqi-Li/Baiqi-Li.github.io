...
- *2024.08*: 🎉🎉 Our [**VQAScore**](https://arxiv.org/pdf/2404.01291.pdf) was rated by [**Imagen**](https://arxiv.org/abs/2408.07009) as the <span style="color:red;">strongest text-to-vision evaluation metric, and our benchmark, [**GenAI-Bench**](https://arxiv.org/pdf/2406.13743), was also extensively used by [**Imagen**](https://arxiv.org/abs/2408.07009). 
